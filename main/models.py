...
class Product(models.Model):
    ...
    color = models.CharField(verbose_name='цвет', max_length= 16, blank=True, null=True)
    price = models.PositiveIntegerField(verbose_name='цена', null=True)
    lamps = models.PositiveIntegerField (verbose_name='количество ламп', default=1, null=True)

...
class Product(models.Model):
    ...
    length = models.CharField(verbose_name='длина', max_length=16, null=True, blank=True)
    width = models.CharField(verbose_name='ширина', max_length=16, null=True, blank=True)
    ...
    styles = models.CharField (verbose_name='стиль', max_length=128, blank=True, null=True)
